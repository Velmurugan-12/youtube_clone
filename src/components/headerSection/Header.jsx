  ...
  return (
    ...
    >
      ...
      <div className="flex items-center group relative">
        <div
          className={`flex h-10 md:ml-10 md:pl-5 border border-[#303030] rounded-l-3xl group-focus-within:border-gray-500 md:group-focus-within:ml-5 md:group-focus-within:pl-0 ${
